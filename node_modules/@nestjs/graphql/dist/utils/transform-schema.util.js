...
function transformSchema(schema, transformType) {
    ...
    function replaceFields(fieldsMap) {
        return mapValues(fieldsMap, (field) => (Object.assign(Object.assign({}, field), { type: replaceType(field.type), args: field.args ? replaceArgs(field.args) : undefined })));
    }
    function replaceInputFields(fieldsMap) {
        return mapValues(fieldsMap, (field) => (Object.assign(Object.assign({}, field), { type: replaceType(field.type) })));
    }
    function replaceArgs(args) {
        return mapValues(args, (arg) => (Object.assign(Object.assign({}, arg), { type: replaceType(arg.type) })));
    }
}
