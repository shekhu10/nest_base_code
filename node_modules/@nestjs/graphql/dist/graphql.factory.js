...
let GraphQLFactory = class GraphQLFactory {
    ...
    mergeOptions(options = { typeDefs: [] }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const typesResolvers = utils_2.extend(this.scalarsExplorerService.explore(), resolvers);
            options.plugins = utils_2.extend(options.plugins || [], this.pluginsExplorerService.explore());
            ...
            if (options.autoSchemaFile) {
                ...
                const executableSchema = schema_1.makeExecutableSchema({
                    resolvers: utils_2.extend(typesResolvers, options.resolvers),
                    typeDefs: apollo_server_core_1.gql `
          ${graphql_1.printSchema(autoGeneratedSchema)}
        `,
                    resolverValidationOptions: Object.assign(Object.assign({}, (options.resolverValidationOptions || {})), { requireResolversForResolveType: 'ignore' }),
                });
                let schema = options.schema
                    ? merge_1.mergeSchemas({
                ...
                if (options.schemaDirectives) {
                    utils_1.SchemaDirectiveVisitor.visitSchemaDirectives(schema, options.schemaDirectives);
                }
                schema = yield transformSchema(schema);
                schema = options.sortSchema ? graphql_1.lexicographicSortSchema(schema) : schema;
      ...
      `,
            ...
            let schema = options.schema
                ...
                : executableSchema;
            utils_2.removeTempField(schema);
            schema = yield transformSchema(schema);
            schema = options.sortSchema ? graphql_1.lexicographicSortSchema(schema) : schema;
            this.gqlSchemaHost.schema = schema;
            return Object.assign(Object.assign({}, options), { typeDefs: undefined, schema });
        ...
        executableSchemaConfig.types
            ...
            if (implementedInterfaces.length > 0) {
                implementedInterfaces.forEach((interfaceRef) => {
                    ...
                    lodash_1.forEach(interfaceRef.getFields(), (value, key) => {
