...
const tsIsDefined = require('ts-is-defined');
...
var MockStore = /** @class */ (function () {
    ...
    MockStore.prototype.set = function (_typeName, _key, _fieldName, _value) {
        ...
        tsIsDefined.assertIsDefined(_key, 'key was not provided');
        var args = {
            typeName: _typeName,
            key: _key,
        };
    ...
    MockStore.prototype.getImpl = function (args) {
        ...
        tsIsDefined.assertIsDefined(key, 'key argument should be given when fieldName is given');
