...
class ApolloGateway {
    constructor(config) {
        ...
        this.experimental_schemaConfigDeliveryEndpoint = config_1.isPrecomposedManagedConfig(this.config)
    ...
    loadStatic(config) {
        ...
        this.queryPlanner = new query_planner_1.QueryPlanner(schema);
